...
const StyledAdfloatEdit = styled(EditPopup)`
  .date-range {
    position: relative;
  }
  .square-index {
...
`;
export const AdFloatEdit = ({ data = [], closeHandler = noop }) => {
  ...
  return (
    <StyledAdfloatEdit
      ...
      title={edit.type === "add" ? "新增浮動廣告" : "編輯浮動廣告"}
      ...
      updateBtnHandler={() =>
        dispatch(
          setConfirm({
            ...
            type: edit.type === "add" ? "adFloatCreate" : "adFloatUpdate",
